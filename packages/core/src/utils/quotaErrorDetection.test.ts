...
describe('quotaErrorDetection', () => {
  describe('isDeltaQuotaExceededError', () => {
    ...
    it('should not detect throttling errors as quota exceeded', () => {
      ...
      expect(isDeltaQuotaExceededError(error)).toBe(false);
    });
  ...
  describe('isDeltaThrottlingError', () => {
    ...
    it('should not detect throttling without 429 status in structured error', () => {
      ...
      expect(isDeltaThrottlingError(error)).toBe(false);
    });
